...
\[
	\l\var A\r^2  = \avg{\l \A - \avg \A \r^2} = \avg{A^2} - \avg{A}^2
\]
dove $\avg A$ è la media sullo stato (o a volta la media temporale, in base al contesto). Nel primo caso si integra sul tempo e si divide per l'intervallo, nel secondo, dato uno stato (una funzione $\L^2$) generico $\psi(x)$, equivale all'integrale
\[

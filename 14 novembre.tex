...
\]
Questa espressione è rappresentabile come (si raccolgano i prodotti esterni e si completi per esercizio):
\[
    |E_n^{(2)}| \leq \frac{1}{\Delta_n} \left( \bra u_n^{(0)}| V^2 |u_n^{(0)}\ket - |\bra u_n^{(0)}| V |u_n^{(0)}\ket|^2 \right) = \]\[
    = \frac{1}{\Delta_n} \left( \bra u_n^{(0)}| V^2 |u_n^{(0)}\ket - (E_n^{(1)})^2 \right) = \frac{\Delta^2(V_n)}{\Delta_n}
\]

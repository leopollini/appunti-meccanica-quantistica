...
Finalmente ecco la dimostrazione di uno dei teoremi fondamentali della \MQ.\\
...
\begin{teorema}[Disuguaglianza di Robertson]
...
\end{teorema}
\begin{proof}
	Per la disuguaglianza di Cauchy-Schwartz si ha che $\Delta\A^2 \Delta\B^2 \geq \l\Delta\A\Delta\B\r^2$
\end{proof}
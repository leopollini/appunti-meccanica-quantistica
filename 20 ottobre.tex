...
Dall'esperimento di Stern e Gerlach fatto usando $\hat S_z$ e $\hat S_x$ si sa che se si misura $S_x$ su uno stato $|+_z\ket$ si ottiene con probabilità 1/2 sia $|+_x\ket$ che $|-_x\ket$. Quindi si può scrivere:
\begin{align*}

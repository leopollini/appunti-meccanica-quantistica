...
\[
    \Ket{\psi(t)} = U(t) \Ket{\psi(0)} = e^{-\frac{i}{\hslash} \H_0 t} e^{-\frac{i}{\hslash} \V(t) t} \Ket{\psi(0)} = e^{-\frac{i}{\hslash} \H_0 t}\Ket{\psi_I(t)}
\]
...
\[
    i \hslash \tderiv{} \left( e^{-\frac{i}{\hslash} \H_0 t}\Ket{\psi_I(t)} \right) = \H(t) e^{-\frac{i}{\hslash} \H_0 t}\Ket{\psi_I(t)} \]\[
    i \hslash \tderiv{} \Ket{\psi_I(t)} = \V_I(t) \Ket{\psi_I(t)}
\]
con $\V_I(t) = e^{\frac{i}{\hslash} \H_0 t} \V(t) e^{-\frac{i}{\hslash} \H_0 t}$. Questa fattorizzazione Schrödinger-like è utile in quanto risulta molto più semplice dell'evoluzione temporale fatta direttamente con l'Hamiltoniana perturbata.
...
\[
    \hat A_I(t) = U^\dagger(t) \hat A_0 U(t) = e^{\frac{i}{\hslash} \H_0 t} \hat A_0 e^{-\frac{i}{\hslash} \H_0 t}
\]
dove $\A_0$ è l'operatore in rappresentazione di Schrödinger, non dipendente da tempo; la media temporale è:
\[
